...
addon:
	...
	$(hide) rm -rf $(PRODUCT_OUT)/kernel-deb  $(PRODUCT_OUT)/pre-requisites  $(PRODUCT_OUT)/README-CIC  $(PRODUCT_OUT)/setup-kernel
...
ifneq ($(TARGET_LOOP_MOUNT_SYSTEM_IMAGES), true)
	...
	tar cvzf $(PRODUCT_OUT)/$(TARGET_AIC_FILE_NAME) -C $(PRODUCT_OUT) aic android.tar.gz aic-manager.tar.gz kernel-deb  pre-requisites  README-CIC  setup-kernel -C docker update
